...
def test_reading_fhir_data(s3_tables_context):
    ...
    spark.sql("SELECT * FROM raw.medication_test").show(10, truncate=True)
    ...
    # spark.sql("DROP TABLE PURGE raw.medication_local").show(10, truncate=False)
    # spark.sql("DROP TABLE PURGE raw.medication_test1").show(10, truncate=False)